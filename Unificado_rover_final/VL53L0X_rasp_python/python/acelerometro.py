# Código de funcionamiento por separado del acelerómetro conectando diréctamente los pines de 
# I2C (SLA y SCL) a los de la Rpi y alimentar a 5V
# Recordar que IeC èrmite comunicaciones simultaneas con diferente address (linea 16 para cambiar)
